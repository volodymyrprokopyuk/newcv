...
%% colors
\setupcolor[hex]
\definecolor[DarkerGray][h=787875]
\definecolor[DarkGray][h=a6a6a8]
\definecolor[Gray][h=c7c9c7]
\definecolor[LightGray][h=e5e5e5]
\definecolor[LighterGray][h=f7f7fa]
\definecolor[Blue][h=005eb8]
\definecolor[Cherry][h=ce0058]
...
\setupfootertexts[{\tfx
  \hspace[40pt]{\darkgray\AwMobile}\hspace[medium]{{ mobile }}
...
%% interaction
\setupinteraction[state=start,color=Blue,style={\it}]
{{ urls.join('\n') }}
...
\setlayer[Background][preset=rightbottom,y=12pt]
  {\rotate[90]{\framed[frame=off]{\tfxx {{ locale.typesetWith }} \CONTEXT}}}
...
\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.objective }} }}\SubSection
{{ objective }}
\stopSubSection
\stopSection
...
%% EDUCATION %%
\startSection
{\tfc\darkgray\AwEducation}\crlf
\rotate[90]{\bfd\darkgray {{ locale.education }}\hspace[1pt]}\Section

\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.education }} }}\SubSection
\stopSubSection
{% for edu in education %}
\startSubSection
{{ edu.from }} \endash\ {{ edu.to }}\SubSection
{{ edu.degree }}\crlf
{{ edu.school }}\crlf
{{ edu.subject }}\crlf
{{ edu.description }}
...
%% EMPLOYMENT %%
\startSection
{\tfc\darkgray\AwEmployment}\crlf
\rotate[90]{\bfd\darkgray {{ locale.employment }}\hspace[small]}\Section

\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.employment }} }}\SubSection
\stopSubSection
{% for emp in employment %}
\startSubSection
{{ emp.from }} \endash\ {{ emp.to }}\SubSection
{{ emp.position }}\crlf
{{ emp.company }}\crlf
{{ emp.department }}
...
\rotate[90]{\bfd\darkgray {{ locale.experience }}\hspace[small]}\Section

\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.experience }} }}\SubSection
\stopSubSection
...
\rotate[90]{\bfd\darkgray {{ locale.proficiency }}\hspace[small]}\Section

\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.proficiency }} }}\SubSection
\stopSubSection
...
\rotate[90]{\bfd\darkgray {{ locale.languages }}\hspace[small]}\Section

\startSubSection
{\bfc\darkgray\unhyphenated{ {{ locale.languages }} }}\SubSection
