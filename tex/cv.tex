...
\definesymbol[AwWeb][\getnamedglyphdirect{Awesome}{github}]
...
\setupfootertexts[{\tfx\Dark
  ...
  \hfill{\Lighter\AwAddress}\hspace[medium]{{ address }}\hfill}]
...
{\bfa\Dark {{ edu.degree.name }}
{%- if edu.subject %}{{ ' in ' + edu.subject }}{% endif -%}
{%- if edu.degree.short %}{{ ', ' + edu.degree.short }}{% endif -%} }\crlf
