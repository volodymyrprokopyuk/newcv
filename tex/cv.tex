...
\setupfootertexts[{\tfx\Dark
  ...
  {% if web %}\hfill{\Lighter\AwWeb}\hspace[medium]{{ web }}{% endif %}\hfill}]
...
{% if web %}\NC\Lighter\AwWeb\NC\Base {{ web }}\NC\MR{% endif %}
...
\midaligned{\starttable[|lp(0.25\textwidth)|lp(0.45\textwidth)|]
...
{% for skill in skills %}
\startSubSection
{\bf\Gray\unhyphenated{ {{ skill.domain }} }}\SubSection
  \startitemize[joinedup,nowhite]
